...
def main(dataset, dataset_setting, spurious_ratio, demean, pca, k_components, group_weighted, alpha,  batch_size, solver, lr,weight_decay,  early_stopping, epochs, balanced_training_main,  per_step, device_type, save_results, seed, folder):
    ...
    results_dict = { 'method': 'ERM', 'parameters' :{'dataset': dataset,'spurious_ratio': spurious_ratio,  'demean': demean, 'pca': pca, 'k_components': k_components, 'group_weighted': group_weighted, 'alpha': alpha, 'batch_size': batch_size, 'solver': solver, 'lr': lr, 'weight_decay': weight_decay, 'early_stopping': early_stopping, 'epochs': epochs, 'balanced_training_main': balanced_training_main, 'per_step': per_step, 'device_type': device_type,  'seed': seed}}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--group_weighted", type=str,  help="whether to use group weighted loss")
    ...
    main(dataset, dataset_setting, spurious_ratio, demean, pca, k_components, group_weighted, alpha,  batch_size, solver, lr,weight_decay,  early_stopping, epochs, balanced_training_main,  per_step, device_type, save_results, seed, folder)
